# Questão: Faça um programa que leia o ano de nascimento de um jovem e informe, de acordo
# com a sua idade, se ele ainda vai se alistar ao serviço militar, se é hora de se alistar
