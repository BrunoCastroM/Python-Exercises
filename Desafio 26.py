# Questão: Faça um programa que leia uma frase pelo teclado e mostre: 1) Quantas vezes aparece a letra "a"; 2) Em que
# posição ela aparece a primeira vez; 3)Em que posição ela aparece a última vez.
