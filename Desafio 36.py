# Questão: Escreva um programa para aprovaar o empréstimo bancário para compra de uma casa. Pergunte o valor da casa, o salário
...
v1=(c/a)/12
v2=s*0.3
print('Para pagar uma casa de R${:.2f} em {} anos, a prestação será de R${:.2f}'.format(c,a,v1))
if v1<=v2:
