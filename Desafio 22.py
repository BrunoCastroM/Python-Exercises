# Questão: Crie um programa que leia o nome completo de uma pessoa e mostre: O nome com todas as letras maiúsculas e
# minúsculas; Quantas letras no total (sem considerar espaços); Quantas letra tem o primeiro nome.
